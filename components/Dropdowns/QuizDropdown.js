...
const QuizDropdown = ({ quiz, chapterSlug, courseSlug }) => {
  ...
  return (
    <>
      ...
      >
        ...
        <Link
          as={`/admin/courses/quiz/${chapterSlug}`}
          passHref
          href="/admin/courses/quiz/[slug]"
        >
          <a
            href="#xarala"
            className={
              ...
              <div className="border-0 bg-gray-200 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="flex items-start justify-between p-5 border-b border-solid border-gray-500 rounded-t rounded-b">
                  <h3 className="text-2xl font-semibold text-black">
                    Modifier le quiz sur {quiz.title}
                  </h3>
                  <button
                ...
                <div className="relative flex-auto">
                  <EditQuizForm quiz={quiz} courseSlug={courseSlug} />
                </div>
              </div>
            </div>
          </div>
