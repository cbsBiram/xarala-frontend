                ...
                <div className="w-full  ml-auto mr-auto px-4">
                  <div className="md:pr-12">
                    ...
                    <p className="text-md leading-relaxed text-gray-700">
                      Les droits à la protection de vos informations –
                      L'essentiel des Règles de confidentialité ainsi que des
                      conditions d'utilisation de vos informations par Xarala.co
                    </p>
                    <h5 className="text-xl font-semibold uppercase mt-10 mb-5">
                      1. Introduction :
                    </h5>
                    ...
                    <p className="text-md leading-relaxed text-gray-700 mb-4">
                      Par exemple, en remplissant un formulaire d'inscription,
                      en achetant une formation, en vous inscrivant à un
                      événement que nous organisons, en participant à une
                      formation, en naviguant sur nos sites Internet ou nos
                      applications mobiles et numériques, vous nous transmettez
                      des informations dont certaines sont de nature à vous
                    ...
                    <p className="text-md leading-relaxed text-gray-700 mb-4">
                      Les présentes règles de confidentialité s'appliquent à
                      toute information que nous collectons ou utilisons sur les
                      sites et dans les applications. Données que nous
                      collectons :
                    </p>
                    <ul className="list-none mt-6">
                      ...
                      <li className="py-2">
                        <div className="flex items-center">
                          ...
                          <div>
                            <h6 className="text-gray-700 text-md">
                              Adresse postale, adresse e-mail, numéro de
                              téléphone ;
                            </h6>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center">
                          ...
                          <div>
                            <h6 className="text-gray-700 text-md">
                              ...
                              paiement (notamment numéro de carte bancaire,
                              compte OM etc...) ;
                            </h6>
                          </div>
                        </div>
                      ...
                      <li className="py-2">
                        <div className="flex items-center">
                          ...
                          <div>
                            <h6 className="text-gray-700 text-md">
                              Toute autre information que vous souhaitez porter
                    ...
                    <p className="text-md leading-relaxed text-gray-700">
                      ...
                      consultation d’un site, d’une application ou d’une
                      publicité en ligne et stocké dans un espace spécifique du
                      disque dur de votre ordinateur ou de votre appareil
                      mobile. Les cookies sont gérés par votre navigateur
                      Internet et seul l’émetteur d’un cookie peut décider de la
                      lecture ou de la modification des informations qui y sont
                      contenues.
                    </p>
                    <p className="text-md leading-relaxed text-gray-700">
                      Nous utilisons des cookies afin de personnaliser et
                      d'optimiser votre expérience en ligne. Vous avez la
                      possibilité de désactiver les cookies, toutefois, cela
                      peut limiter votre utilisation de certaines
                      fonctionnalités ou fonctions de nos sites et applications.{' '}
                    </p>
                    <h5 className="text-xl font-semibold uppercase mt-10 mb-5">
