              ...
              <div className="flex flex-wrap justify-center">
                <div className="w-full md:w-6/12 ml-auto mr-auto px-4">
                  <div className="md:pr-2">
                    ...
                    ></div>
                    <p className="mt-4 text-lg leading-relaxed text-gray-600">
                      Nous offrons des formations professionnelles enseignées
                      par des formateurs expérimentés et professionnels.
                    </p>
                    <ul className="list-none mt-6">
                      <li className="py-4">
                        <div className="flex">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600">
                              Des contenus professionnels et accessibles
                              quelques soit votre niveau ou votre langue.
                            </p>
                          </div>
                        </div>
                      </li>
                      ...
                      <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                        <div className="px-4 py-5 flex-auto">
                          ...
                          <p className="mt-2 mb-4 text-gray-600">
                            ...
                            problèmes au quotidien et des cas d'utilisation
                            réels.
                          </p>
                        </div>
                      </div>
