      ...
      <div className="relative pt-10 flex items-center">
        <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
          <div className="max-w-md">
            <div className="text-5xl font-dark font-bold">400</div>
            <p className="text-2xl md:text-3xl font-light leading-normal">
              Vous n'avez pas les droits pour accéder à cette page.
            </p>
            <p className="mb-8">
              Essayez de changer votre type de compte ou bien laisser nous un
              message sur la page contact.
            </p>
            {me && (
              <Link href="/admin/settings">
                <button className="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-blue-400 active:bg-blue-600 hover:bg-blue-700">
                  Mon compte
                </button>
              </Link>
            )}
            <Link href="/contact">
              <button className="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-pink-500 active:bg-blue-600 ml-2">
                Contactez-nous
              </button>
            </Link>
          </div>
